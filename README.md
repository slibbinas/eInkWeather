...
- **Simple ("wife") mode** — no graphs: a big temperature, the **feels-like** temperature and
  a witty plain-language advice on what to wear, with clothing pictograms (t-shirt, sweater,
  jacket, beanie, umbrella) and a morning / afternoon / evening strip.
